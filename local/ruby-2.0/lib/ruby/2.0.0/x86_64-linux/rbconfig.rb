...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/isucon/local/ruby-2.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/isucon/local/ruby-2.0' 'LDFLAGS=-L'\\\\''/home/isucon/local/ruby-2.0/lib'\\\\'' ' 'CPPFLAGS=-I'\\\\''/home/isucon/local/ruby-2.0/include'\\\\'' '"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I'/home/isucon/local/ruby-2.0/include'  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L'/home/isucon/local/ruby-2.0/lib'  -fstack-protector -rdynamic -Wl,-export-dynamic"
